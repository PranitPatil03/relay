...
export function GitHubAuthButton({ dark }: { dark?: boolean }) {
  ...
  return (
    <Button
      variant="outline"
      className={`w-full ${dark ? 'border-white/10 bg-white/5 text-white hover:bg-white/10 hover:text-white' : 'border-white/10 bg-white/5 text-white hover:bg-white/10 hover:text-white'}`}
